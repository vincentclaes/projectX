    ...
    def gen_tweets(pages):
        ...
        while pages > 0:
            ...
            for tweet in html.find('.stream-item'):
                ...
                replies = int("".join(interactions[0].split(" ")[0].replace(comma, "").replace(dot, "").split()))
                retweets = int("".join(interactions[1].split(" ")[0].replace(comma, "").replace(dot, "").split()))
                likes = int("".join(interactions[2].split(" ")[0].replace(comma, "").replace(dot, "").split()))
